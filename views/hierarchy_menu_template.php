<div class="item deep_{deep}" id="hierarchy_id_{hierarchy_id}">
	...
	<form method="post" action="<?php echo site_url(); ?>/menu/new_parent/{hierarchy_id}">
		<fieldset>
			<label>Order:</label>
			<a class="order_decrease" href="<?php echo site_url('menu/order_decrease/' . $hierarchy_id);?>" title="Move element up">Move Up</a><a class="order_increase" href="<?php echo site_url('menu/order_increase/' . $hierarchy_id);?>" title="Move element down">Move Down</a>
		</fieldset>
		<fieldset>
		...
		<fieldset>
			...
			<a href="<?php echo site_url('menu?parent_id=' . $hierarchy_id . '#add_menu_item'); ?>" class="button child">Add Child</a>
		</fieldset>
		<fieldset>
